	...
	<section id="One" class="wrapper style3">
		<div class="inner">
			<header class="align-center">
				<a href="/semiProject/JY/NoticeForm.do"><p>고객센터</p></a>
				<a href="/semiProject/JY/NoticeForm.do"><h2>공지사항</h2></a>
			</header>
		</div>
	</section>
					...
					<div class=tablediv>
							...
							<table border="1" width="540" cellpadding="0" cellspacing="0"
								...
								<c:forEach var="article" items="${articleList}">
									...
									<tr height="30">
										...
										<td width="250"><a
											href="/semiProject/JY/NoticeDetailForm.do?num=${article.n_num}&pageNum=${currentPage}">
						...
						<div style="text-align: center">
							<c:if test="${count > 0}">
								...
								<c:if test="${endPage < pageCount}">
									<a
										href="/semiProject/JY/NoticeForm.admin?pageNum=${startPage + 10}">[다음]</a>
								</c:if>
							</c:if>
