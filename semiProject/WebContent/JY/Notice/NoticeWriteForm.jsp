...
<script>
   function writesubmit(writeForm){
	   if(!writeForm.n_subject.value){
		   alert("제목을 입력해주세요");
		   return false;
	   }
	   if(!writeForm.n_content.value){
		   alert("내용을 입력해주세요");
		   return false;
	   }
   ...
   function modifysubmit(modifyForm){
	   if(!modifyForm.n_subject.value){
		   alert("제목을 입력해주세요");
		   return false;
	   }
	   if(!modifyForm.n_content.value){
		   alert("내용을 입력해주세요");
		   return false;
	   }
...
<body bgcolor="${bodyback_c}">
 ...
 <tiles:insertDefinition name="adminheader" />
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<c:if test="${modify == 0  }">
		<h3 class="sub-header">공지사항 작성하기</h3>
		<form name="write" action="/semiProject/JY/NoticeWritePro.admin"  method="post">
			<table width="400" border="0" cellspacing="0" cellpadding="0"  align="center">
			<tr>
				<td width="330">
				<input type="text" size="40" maxlength="50" name="n_subject" placeholder="제목을 입력해주세요"></td>
			</tr>
			<tr>
				<td>
				<br>
			...
			<tr>
				<td width="330">
					<textarea name="n_content" rows="13" cols="50" placeholder="내용을 입력해주세요." style="resize:none;"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="right">
					<input type="button" value="목록보기" OnClick="window.location='/semiProject/JY/NoticeForm.admin?pageNum=${pageNum}'">
		...
		<c:if test="${modify == 1 }">
		<h3 class="sub-header">공지사항 수정하기</h3>
		<form name="modify" method="post" action="/semiProject/JY/NoticeModifyPro.admin">
			<input type="hidden" name="num" value="${n_num}">
			
			<table width="400" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td width="70" align="center">제목</td>
					<td align="left" width="330">
						<input type="text" size="40" maxlength="50" name="n_subject" value="${article.n_subject}">
					</td>
				</tr>
				<tr>
					<td width="70" align="center">내용</td>
					<td align="center" width="330">
						<textarea name="n_content" rows="13" cols="40" style="resize:none;">${article.n_content}</textarea>
					</td>
				</tr>
				<tr>     
					<td colspan=2 align="center">
						<input type="button" value="완료" onclick="modifysubmit(this.form)">
						<input type="button" value="취소" onclick="document.location.href='/semiProject/JY/NoticeForm.admin?pageNum=${pageNum}'">
					</td>
				</tr>
			</table>
		</form>
