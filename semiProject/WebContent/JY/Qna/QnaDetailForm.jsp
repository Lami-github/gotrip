		...
		<table width="500" border="1" cellspacing="0" cellpadding="0"
			...
			<tr height="30">
				<td colspan="4" bgcolor="${value_c}" align="right">
						<input type="button" value="글수정" onclick="document.location.href='/semiProject/JY/QnaModifyForm.admin?num=${article.q_num}&pageNum=${pageNum}'">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="글삭제" onclick="document.location.href='/semiProject/JY/QnaDeletePro.admin?num=${article.q_num}&pageNum=${pageNum}'">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="글목록" onclick="document.location.href='/semiProject/JY/QnaForm.admin?pageNum=${pageNum}'">
				</td>
			</tr>
		</table>
	</form>
